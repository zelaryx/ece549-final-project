...
for filename in sorted(os.listdir(directory)):
    if filename.lower().endswith('.jpg') or filename.lower().endswith('.png'):
        ...
        # print("Predicted class:", mapping_dict[predicted_class])

        print("Predicted class:", alphabets_mapper[predicted_class], "True class:", true_class)
        if alphabets_mapper[predicted_class] == true_class:
            accuracy.append(1)
        else:
            accuracy.append(0)
